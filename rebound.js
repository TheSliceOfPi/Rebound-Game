...
function init(){
    ...
    difficultySelect.addEventListener('change',function(){
        changeDifficulty(difficultySelect.selectedIndex)
    },false);
...
function initAudio(){
    //load audio files
    beepX = new Audio('assets/beepX.mp3');
    beepY = new Audio('assets/beepY.mp3');
    beepPaddle = new Audio('assets/beepPaddle.mp3');
    beepGameOver = new Audio('assets/beepGameOver.mp3');
